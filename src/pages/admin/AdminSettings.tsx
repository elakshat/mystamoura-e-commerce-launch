              ...
              <div className="bg-card rounded-xl border border-border p-6 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Enter your GA4 Measurement ID (starts with G-). Find it in Google Analytics → Admin → Data Streams → your stream.
                  </p>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="ga-id" className="text-foreground">Measurement ID</Label>
                      <Input
                        id="ga-id"
                    ...
                    <Button
                      onClick={() => handleSave('ga_measurement_id', gaMeasurementId)}
                      disabled={updateSettings.isPending}
                    >
                      {updateSettings.isPending ? (
                        <Loader2 className="h-4 w-4 mr-2 animate-spin" />
